...
public class VectorTest {
    ...
    public void testNormalize() {
        ...
        // TC01: positive
        Vector v1 = new Vector(1,2,2);
        assertEquals("cant normalized" , new Vector((double) 1/3,(double)2/3,(double)2/3),v1.normalize());

        // TC02: negative
        Vector v2 = new Vector(-1,-2,-2);
        assertEquals("cant normalized" , new Vector((double)-1/3,(double)-2/3,(double)-2/3),v2.normalize());
